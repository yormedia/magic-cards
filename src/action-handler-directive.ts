...
// TODO You need to replace all instances of "action-handler-magic" with "action-handler-<your card name>"
customElements.define('action-handler-magic', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-magic')) {
    return body.querySelector('action-handler-magic') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-magic');
